!(function () {
  ...
  function D(n) {
    ...
    return function (e, r) {
      ...
      r
        ? ((t.lastIndex = 0),
          t.test(u) || e.setAttribute("class", q(u + " " + n)))
        : e.setAttribute("class", q(u.replace(t, " ")));
    };
  }
  function P(n, t, e) {
    function r() {
  ...
  function W(e) {
    ...
    if (
      (null == Ea &&
        (Ea = "onselectstart" in e ? !1 : x(e.style, "userSelect")),
      Ea)
    ) {
      var o = n(e).style,
        a = o[Ea];
  ...
  function gt(n, t, e) {
    return n > 0
      ? new lt(Math.atan2(e, t) * Pa, Math.sqrt(t * t + e * e), n)
      : new lt(0 / 0, 0 / 0, n);
  }
  function pt(n) {
  ...
  function qt() {
    var n = Lt(),
      t = Tt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(tc), (tc = setTimeout(qt, t))), (nc = 0))
      : ((nc = 1), rc(qt));
  }
  function Lt() {
    var n = Date.now();
  ...
  function De(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - Ra - Ca : Ra - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - Ra - Ca : Ra - t[1])
    );
  }
  function Pe(n) {
    var t,
      ...
      if (s)
        for (
          ...
          var m = n[0],
            ...
            k = p * M;
          if (
            (yc.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
            (i += S ? b + _ * La : b),
            S ^ (h >= e) ^ (m >= e))
          ) {
            var E = de(pe(f), pe(n));
        ...
        if (((i = e - c), p || !(0 > i))) {
          ...
          if (((i = t - l), v || !(i > 0))) {
            ...
            if (((i = r - l), v || !(0 > i))) {
              ...
              return (
                h > 0 && (u.a = { x: c + h * p, y: l + h * v }),
                1 > g && (u.b = { x: c + g * p, y: l + g * v }),
                u
              );
            }
          }
  ...
  function Ie(n, t, e, r) {
    ...
    return function (a) {
      ...
      function g() {
        v && (p(y, M), x && w && A.rejoin(), v.push(A.buffer())),
          (C.point = f),
          w && a.lineEnd();
      }
      function p(n, t) {
      ...
      var v,
        ...
        C = {
          ...
          polygonEnd: function () {
            ...
            (e || u) &&
              (a.polygonStart(),
              e && (a.lineStart(), l(null, null, 1, a), a.lineEnd()),
              u && Ce(v, i, t, l, a),
              a.polygonEnd()),
              (v = d = m = null);
          },
    ...
    function u(t, e, r, a, c, l, s, f, h, g, p, v, d, m) {
      ...
      if (x > 4 * i && d--) {
        var b = a + g,
          ...
          L = M * z - y * q;
        ((L * L) / x > i ||
          ga((y * z + M * q) / x - 0.5) > 0.3 ||
          o > a * g + c * p + l * v) &&
          (u(t, e, r, a, c, l, N, C, E, (b /= S), (_ /= S), w, d, m),
          m.point(N, C),
  ...
  function ir(n) {
    ...
    return (
      ...
      (t.clipAngle = function (n) {
        return arguments.length
          ? ((b = null == n ? ((w = n), Lc) : He((w = +n) * Da)), u())
          : w;
      }),
      (t.clipExtent = function (n) {
        return arguments.length
          ? ((S = n), (_ = n ? Ie(n[0][0], n[0][1], n[1][0], n[1][1]) : y), u())
          : S;
      }),
      (t.scale = function (n) {
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * Pa,
              Math.atan2(o, Math.sqrt(r * r + u * u)) * Pa,
            ];
          }
        : function () {
            return [n * Pa, t * Pa];
  ...
  function _r(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(o / r, 1 / i)) - Ra,
          ];
        }),
        e)
      : Sr;
  ...
  function Ur(n) {
    ...
    for (
      var c = i;
      c.circle && ga(e - c.circle.x) < Ca && ga(r - c.circle.cy) < Ca;
    ...
    for (
      var l = o;
      l.circle && ga(e - l.circle.x) < Ca && ga(r - l.circle.cy) < Ca;
  ...
  function Xr(n) {
    var t = n.circle;
    t &&
      (t.P || (nl = t.N), tl.remove(t), rl.push(t), tu(t), (n.circle = null));
  }
  function $r(n) {
    for (
      var t, e = Gc, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
      ...
      (t = e[u]),
        (!Br(t, n) ||
          !r(t) ||
          (ga(t.a.x - t.b.x) < Ca && ga(t.a.y - t.b.y) < Ca)) &&
  ...
  function iu(n, t) {
    ...
    for (Gc = [], Kc = new Array(n.length), Qc = new nu(), tl = new nu(); ; )
      if (((u = nl), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          ((Kc[i.i] = new Or(i)), jr(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        Ur(u.arc);
  ...
  function du(n, t) {
    ...
    for (n += "", t += ""; (e = il.exec(n)) && (r = ol.exec(t)); )
      (u = r.index) > i &&
        ((u = t.slice(i, u)), a[o] ? (a[o] += u) : (a[++o] = u)),
        (e = e[0]) === (r = r[0])
          ? a[o]
            ? (a[o] += r)
            : (a[++o] = r)
          : ((a[++o] = null), c.push({ i: o, x: vu(e, r) })),
        (i = ol.lastIndex);
    return (
  ...
  function mu(n, t) {
    for (
      var e, r = ta.interpolators.length;
      --r >= 0 && !(e = ta.interpolators[r](n, t));
  ...
  function Pu(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Pa),
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: vu(a[0], c[0]) }, { i: 3, x: vu(a[1], c[1]) }))
        : r.push(c[0] || c[1] ? "translate(" + c + ")" : ""),
      l != s
        ? (l - s > 180 ? (s += 360) : s - l > 180 && (l += 360),
          u.push({
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: vu(f, h) })
  ...
  function Vu(n, t) {
    if (n === t) return n;
    for (
      var e = Zu(n), r = Zu(t), u = e.pop(), i = r.pop(), o = null;
      u === i;
  ...
  function Gu(n, t) {
    return (
      ta.rebind(n, t, "sort", "children", "value"),
      (n.nodes = n),
      (n.links = ri),
      n
    );
  ...
  function Mi(n) {
    ...
    if ((e = n.children) && (l = e.length)) {
      ...
      if (
        ...
        (r.y = 0),
        t(r),
        l > 1 && ((u = e[1]), (u.x = u.r), (u.y = 0), t(u), l > 2))
      )
        for (
          i = e[2],
            wi(r, u, i),
  ...
  function Wi(n, t) {
    var e = Bi(t[2]);
    return n in yl
      ? Math.abs(e - Bi(Math.max(ga(t[0]), ga(t[1])))) + +("e" !== n)
      : e - 2 * ("%" === n);
  }
  function Ji(n, t, e, r) {
    function u(n) {
    ...
    return (
      ...
      (o.tickFormat = function (n, t) {
        ...
        arguments.length < 2
          ? (t = Ml)
          : "function" != typeof t && (t = ta.format(t));
        var r,
  ...
  function Gi(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function (o) {
        return arguments.length
          ? ((u = Ki((t = o))), (i = Ki(1 / t)), n.domain(e.map(u)), r)
          : t;
      }),
      (r.copy = function () {
  ...
  function Qi(n, t) {
    ...
    return (
      ...
      (e.range = function (n) {
        return arguments.length
          ? ((i = n), (o = 0), (t = { t: "range", a: arguments }), e)
          : i;
      }),
      ...
      (e.rangeRoundPoints = function (u, a) {
        ...
        return (
          (i = r(
            c + Math.round((s * a) / 2 + (l - c - (n.length - 1 + a) * s) / 2),
            s
          )),
          (o = 0),
  ...
  function ho(n) {
    function t(t) {
      ...
      for (
        var c, l = [], s = [], f = -1, h = t.length, g = Et(e), p = Et(r);
        ++f < h;

      )
        u.call(this, (c = t[f]), f)
          ? s.push([+g.call(this, c, f), +p.call(this, c, f)])
          : s.length && (o(), (s = []));
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = El.get(n) || go).key),
            t)
          : o;
      }),
  ...
  function xo(n, t) {
    return n.length < 3
      ? go(n)
      : n[0] +
          _o((n.push(n[0]), n), wo([n[n.length - 2]].concat(n, [n[1]]), t));
  }
  function bo(n, t) {
  ...
  function Do(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = El.get(n) || go).key),
            (l = a.reverse || a),
            (s = a.closed ? "M" : "L"),
            t)
          : c;
          ...
          function (u) {
            ...
            function l(e) {
              ...
              for (var u = e / f, a = h(u), c = v.length; c > 0; )
                v[--c].call(n, a);
              return u >= 1
                ? (o.event && o.event.end.call(n, n.__data__, t), s())
                : void 0;
            }
            function s() {
  ...
  c(l, {
    ...
    (ta.nest = function () {
      function n(t, o, a) {
        ...
        for (
          var c, s, f, h, g = -1, p = o.length, v = i[a++], d = new l();
          ++g < p;
  ...
  (ta.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        wa.hasOwnProperty(e) ? { space: wa[e], local: n } : n
      );
    },
  }),
      ...
      function e(n, e) {
        ...
        if (t) {
          var d,
            ...
            y = new Array(o);
          for (r = -1; ++r < o; )
            m.has((d = t.call((u = n[r]), u.__data__, r)))
              ? (v[r] = u)
              : m.set(d, u),
              (y[r] = d);
          for (r = -1; ++r < f; )
  ...
  (ta.selection.enter = Z),
    ...
    (Sa.select = function (n) {
      for (var t, e, r, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
        ...
        for (var l = -1, s = u.length; ++l < s; )
          (i = u[l])
            ? (t.push((r[l] = e = n.call(u.parentNode, i.__data__, l, a))),
    ...
    (ta.select = function (t) {
      ...
      return (
        "string" == typeof t
          ? ((e = [Ma(t, ua)]), (e.parentNode = ua.documentElement))
    ...
    (ta.selectAll = function (n) {
      ...
      return (
        "string" == typeof n
          ? ((t = ra(xa(n, ua))), (t.parentNode = ua.documentElement))
      ...
      function e(n, t, e, i, o) {
        return function () {
          ...
          var l,
            ...
            M = t(h, v);
          u
            ? ((l = u.apply(s, arguments)), (l = [l.x - M[0], l.y - M[1]]))
            : (l = [0, 0]),
            g({ type: "dragstart" });
        };
      }
  ...
  (ta.interpolateZoom = function (n, t) {
    ...
    (ta.behavior.zoom = function () {
      ...
      function h() {
        ...
        function a() {
          if (ta.event.touches.length) {
            for (
              var t = ta.event.changedTouches, e = 0, r = t.length;
              r > e;
              ++e
            )
      ...
      function g() {
        ...
        y
          ? clearTimeout(y)
          : ((v = e((d = m || ta.mouse(this)))), Dl.call(this), c(n)),
      ...
      function p() {
        ...
        o(
          ...
          n,
          e(n),
          ta.event.shiftKey ? Math.ceil(t) - 1 : Math.floor(t) + 1
        );
      }
      var v,
        d,
  ...
  (Za.brighter = function (n) {
    return new lt(
      this.h,
      this.c,
      Math.min(100, this.l + Va * (arguments.length ? n : 1))
    );
  }),
    (Za.darker = function (n) {
      return new lt(
        this.h,
        this.c,
        Math.max(0, this.l - Va * (arguments.length ? n : 1))
      );
    }),
    (Za.rgb = function () {
    ...
    (ta.dsv = function (n, t) {
      ...
      return (
        ...
        (e.parseRows = function (n, t) {
          ...
          for (
            var r, u, i = {}, o = {}, a = [], l = n.length, s = 0, f = 0;
            (r = e()) !== o;
  ...
  (ta.timer = function (n, t, e) {
    ...
    Qa ? (Qa.n = i) : (Ka = i),
      (Qa = i),
      nc || ((tc = clearTimeout(tc)), (nc = 1), rc(qt));
  }),
  ...
  var ic = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    oc = ta.map({
      ...
      r: function (n, t) {
        return (n = ta.round(n, Rt(n, t))).toFixed(
  ...
  (ac.year = Ft(
    ...
    [
      ...
      var e = (ac[n] = Ft(
        function (n) {
          return (
            (n = ac.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
  ...
  (ta.geo.path = function () {
    ...
    return (
      ...
      (n.projection = function (n) {
        return arguments.length
          ? ((u = (e = n) ? n.stream || tr(n) : y), t())
          : e;
      }),
      (n.context = function (n) {
        return arguments.length
          ? ((i = null == (r = n) ? new $e() : new Qe(n)),
    ...
    (ta.geo.rotation = function (n) {
      ...
      return (
        ...
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Da, t[1] * Da)), (t[0] *= Pa), (t[1] *= Pa), t
          );
        }),
        t
      );
    ...
    (ta.geo.distance = function (n, t) {
      var e,
        ...
        f = Math.cos(i);
      return Math.atan2(
        Math.sqrt((e = f * o) * e + (e = l * s - c * f * a) * e),
        c * s + l * f * a
      );
    }),
    ...
    (Jc.clip = function (n) {
      for (
        ...
        for (
          ...
          (o = t[e]),
            qr(o, s, u)
              ? (qr(i, s, u) || n.push(Lr(i, o, s, u)), n.push(o))
              : qr(i, s, u) && n.push(Lr(i, o, s, u)),
            (i = o);
        a && n.push(n[0]), (s = u);
      }
      return n;
    ...
    (ta.layout.chord = function () {
      function n() {
        ...
        for (
          ...
          (r[y] = { index: y, startAngle: f, endAngle: l, value: (l - f) / n }),
            (l += s);
        }
        for (h = -1; ++h < i; )
          for (g = h - 1; ++g < i; ) {
          ...
          return (
            e ||
              (e = ta.behavior
                .drag()
                .origin(y)
                .on("dragstart.force", Xu)
                .on("drag.force", t)
                .on("dragend.force", $u)),
            arguments.length
              ? void this.on("mouseover.force", Bu)
                  .on("mouseout.force", Wu)
                  .call(e)
              : e
          );
        }),
  ...
  ta.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : vl.get(t) || ai), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : dl.get(t) || ci), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
  ...
  var vl = ta.map({
      "inside-out": function (n) {
        ...
        for (t = 0; r > t; ++t)
          (e = o[t]),
            c > a ? ((a += i[e]), l.push(e)) : ((c += i[e]), s.push(e));
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (a = l[i]),
            a >= s[0] &&
              a <= s[1] &&
              ((o = c[ta.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
      return c;
    }
    var t = !0,
      e = Number,
        ...
        if (t) {
          for (
            ...
            (c = ki(c)),
              ...
              (h += c.m),
              (s += i.m);
          o && !Ei(i) && ((i.t = o), (i.m += f - s)),
            u && !ki(c) && ((c.t = u), (c.m += l - h), (e = n));
        }
        return e;
      }
      function i(n) {
      ...
      return (
        ...
        (i.padding = function (n) {
          function t(t) {
            ...
            return null == e
              ? Ri(t)
              : Di(t, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return Di(t, n);
          }
      ...
      function n() {
        ...
        if (
          ((m = (+c.apply(this, arguments) || 0) / 2) &&
            ((d =
              i === kl ? Math.sqrt(n * n + l * l) : +i.apply(this, arguments)),
            g || (A *= -1),
        ...
        if (
          (p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > 0.001
        ) {
          v = (l > n) ^ g ? 0 : 1;
          var T =
              null == S
            ...
            j =
              ...
              Math.sin(
                Math.acos(
                  (R * P + D * U) /
                    (Math.sqrt(R * R + D * D) * Math.sqrt(P * P + U * U))
                ) / 2
              ),
          ...
          N.push("M", y, ",", M),
            null != x &&
              N.push("A", l, ",", l, " 0 ", C, ",", g, " ", x, ",", b),
            N.push("L", _, ",", w),
            null != S &&
              N.push("A", n, ",", n, " 0 ", q, ",", 1 - g, " ", S, ",", k);
      ...
      return (
        ...
        (n.centroid = function () {
          var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
            t =
              (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 - Ra;
  ...
  (_a.transition = function (n) {
    for (
      var t,
        ...
        u = Xo(n),
        i = [],
        o = Rl || { time: Date.now(), ease: Su, delay: 0, duration: 250 },
        a = -1,
        c = this.length;
      ++a < c;
  ...
  (Pl.call = _a.call),
    ...
    (Pl.each = function (n, t) {
      ...
      if (arguments.length < 2) {
        ...
        Y(this, function (u) {
          var i = u[r][e];
          (i.event || (i.event = ta.dispatch("start", "end", "interrupt"))).on(
            n,
            t
          );
        });
          ...
          if (
            ("bottom" === r || "top" === r
              ? ((n = Bo),
                ...
                (S = "x2"),
                (E = "y2"),
                C.attr("dy", 0 > L ? "0em" : ".71em").style(
                  "text-anchor",
                  "middle"
                ),
                _.attr(
                  "d",
                  "M" + x[0] + "," + L * i + "V0H" + x[1] + "V" + L * i
                ))
              : ((n = Wo),
                (w = "y"),
                (k = "x"),
  ...
  ta.svg.brush = function () {
    function n(t) {
      t.each(function () {
        ...
        l && ((c = Ui(l)), h.attr("x", c[0]).attr("width", c[1] - c[0]), r(f)),
          s &&
            ((c = Ui(s)), h.attr("y", c[0]).attr("height", c[1] - c[0]), u(f)),
          e(f);
      });
    }
    function e(n) {
    ...
    function i() {
      function i() {
        32 == ta.event.keyCode &&
          (C || ((M = null), (q[0] -= f[1]), (q[1] -= h[1]), (C = 2)), S());
      }
      function v() {
        32 == ta.event.keyCode &&
          2 == C &&
          ((q[0] += f[1]), (q[1] += h[1]), (C = 0), S());
      }
      function d() {
        var n = ta.mouse(b),
          t = !1;
      ...
      function m(n, t, e) {
        ...
        return (
          ...
          C
            ? (u = (r += s) + d)
            : (M && (s = Math.max(c, Math.min(l, 2 * M[e] - r))),
              r > s ? ((u = r), (r = s)) : (u = s)),
          v[0] != r || v[1] != u
            ? (e ? (a = null) : (o = null), (v[0] = r), (v[1] = u), !0)
            : void 0
        );
      }
      function y() {
      ...
      if (
        (ta.event.changedTouches
          ? L.on("touchmove.brush", d).on("touchend.brush", y)
          : L.on("mousemove.brush", d).on("mouseup.brush", y),
        ...
        return arguments.length
          ...
          : (l &&
              (o
                ...
                : ((e = f[0]),
                  (r = f[1]),
                  l.invert && ((e = l.invert(e)), (r = l.invert(r))),
                  e > r && ((c = e), (e = r), (r = c)))),
            s &&
              (a
                ? ((u = a[0]), (i = a[1]))
  ...
  (Wl.year = ac.year.utc),
    ...
    "function" == typeof define && define.amd
      ? define(ta)
      : "object" == typeof module && module.exports && (module.exports = ta),
    (this.d3 = ta);
})();
